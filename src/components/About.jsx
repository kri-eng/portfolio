        ...
        <div className="flex flex-col items-center">
          <div className="w-full md:w-2/3 space-y-12">
            <p className="text-lg text-gray-700">
              As a Computer Science graduate from the University of Illinois at Chicago and a current Master's student at the Georgia Institute of Technology, I possess a robust foundation in programming, problem-solving, and software development. My academic journey has been complemented by practical experiences and a passion for iOS mobile engineering.
            </p>
            <p className="text-lg text-gray-700">
            ...
            <p className="text-lg text-gray-700">
              With a keen interest in continuous learning and staying up-to-date with emerging technologies, I am actively seeking opportunities to contribute my skills and passion for iOS mobile engineering to innovative projects. My goal is to leverage my diverse technical skill set, from Python and Java to AWS and React, to build solutions that drive efficiency and enhance user experiences.
              <br />
              <br />
